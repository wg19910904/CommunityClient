...
@interface JHHeadLinesSlideVC : JHBaseVC
//必填，标签栏标题字符串数组
@property (nonatomic, strong) NSMutableArray *cbs_titleArray;

//必填，每个标签对应ViewController字符串数组，数量应与cbs_titleArray一样
@property (nonatomic, strong) NSMutableArray *cbs_viewArray;
