...
@interface YFPayTool ()<PayPalPaymentDelegate, PayPalFuturePaymentDelegate, PayPalProfileSharingDelegate>
...
-(void)AlipayWith:(NSDictionary *)resultDic block:(PayResultBlock)resultBlock{
    ...
    NSString *appScheme=@"CommunityClientV3";//用来区别不同app的标示，需要在info.plist文件中配置
