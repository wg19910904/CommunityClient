...
@interface JHOther ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,UIPickerViewDataSource,UIPickerViewDelegate,UITextViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,AVAudioPlayerDelegate>
{
...
-(void)initData{
    ...
    self.navigationItem.title = NSLocalizedString(@"其他", nil);
    
    [HttpTool postWithAPI:@"client/paotui/gongshi" withParams:@{@"type":@"other"} success:^(id json) {
        NSLog(@"%@",json);
        if ([json[@"error"]intValue] == 0) {
            _other_start_price = json[@"data"][@"config"][@"other_start_price"];
            min_num = [_other_start_price floatValue];
            money = min_num;
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.row == 0) {
        ...
        cell.start_price = _other_start_price;
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        return cell;
    }else{
...
-(void)clickToTrue{
    ...
    SHOW_HUD
    [HttpTool postWithAPI:@"client/paotui/other" params:dic dataDic:dataDic success:^(id json) {
        HIDE_HUD
