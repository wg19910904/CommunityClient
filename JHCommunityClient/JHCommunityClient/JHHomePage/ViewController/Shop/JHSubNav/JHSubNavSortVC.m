...
@interface JHSubNavSortVC ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,copy)NSArray *dataArray;

@end

@implementation JHSubNavSortVC
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)createTable
{
    ...
    if (!_mainTableView) {
        _mainTableView = [[UITableView alloc] initWithFrame:FRAME(0, 0, WIDTH, 160.5)
