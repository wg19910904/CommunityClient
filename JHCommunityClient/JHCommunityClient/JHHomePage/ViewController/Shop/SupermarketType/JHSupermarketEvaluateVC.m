...
@interface JHSupermarketEvaluateVC ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic, strong)UITableView *mainTableView;

@end

@implementation JHSupermarketEvaluateVC
{
    //刷新
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if ([scoreDic[@"count"] doubleValue] == 0.0) {
        ...
        scoreLabel.text = [NSString stringWithFormat:@"%3.1g分",scoreV];
    }
