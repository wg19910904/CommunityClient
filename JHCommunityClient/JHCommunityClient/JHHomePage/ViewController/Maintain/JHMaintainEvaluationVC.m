...
@interface JHMaintainEvaluationVC ()<UIPageViewControllerDelegate>
{
...
@implementation JHMaintainEvaluationVC
...
- (void)initVCArray
{
    ...
    for(int i = 0 ; i < 4; i ++)
    {
        JHMaintainEvaluationSubVC *sub = [[JHMaintainEvaluationSubVC alloc] init];
