...
@interface JHHouseKeepingOrderDetailVC ()<UIWebViewDelegate,UIScrollViewDelegate>
{
    UIWebView *_webView;
...
@implementation JHHouseKeepingOrderDetailVC
...
- (void)createUI
{
    ...
    _displayImg.contentMode = UIViewContentModeScaleToFill;
    ...
    NSString *str = [NSString stringWithFormat:NSLocalizedString(@"%@元起", nil),self.start];
...
- (void)requestData
{
    ...
    [HttpTool postWithAPI:@"client/house/detail" withParams:dic success:^(id json) {
        NSLog(@"json%@",json);
