...
@interface JHHouseKeepingDetailVC ()<UITableViewDataSource,UITableViewDelegate>
{
    ...
    JHHouseKeepingEvaluationVC *_evaluationVc;
    NSMutableArray *_servierTableViewArray;
    HoseKeepingDetailModel *_detailModel;
...
@implementation JHHouseKeepingDetailVC
...
- (void)viewDidLoad {
    ...
    _detailModel = [[HoseKeepingDetailModel alloc] init];
    _evaluationVc = [[JHHouseKeepingEvaluationVC alloc] init];
...
- (void)requestData
{
    ...
    [HttpTool postWithAPI:@"client/house/staffdetail" withParams:_dic success:^(id json) {
        ...
        if([json[@"error"] isEqualToString:@"0"])
        {
            ...
            {
                HouseKeepingSeriverKindModel *model = [[HouseKeepingSeriverKindModel alloc] init];
...
{
    _detailBackView.frame = FRAME(0, NAVI_HEIGHT, WIDTH, 70);
    ...
    [_iconImg sd_image:url plimage:IMAGE(@"houseicon")];
    ...
    {
        _nameLabel.text = NSLocalizedString(@"家政阿姨", nil);
    }
...
- (void)createSeriverKind
{
    ...
    {
        _seriverTableView = [[UITableView alloc] initWithFrame:FRAME(0, NAVI_HEIGHT + 80 + 45, WIDTH, HEIGHT - NAVI_HEIGHT-80-45) style:UITableViewStylePlain];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    JHHouseKeepingSeriverKindCell *cell = [_seriverTableView dequeueReusableCellWithIdentifier:identifier];
    if(cell == nil)
    {
        cell = [[JHHouseKeepingSeriverKindCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
...
{
    HouseKeepingSeriverKindModel *model = _servierTableViewArray[indexPath.row];
    JHHouseKeepingOrderVC *order = [[JHHouseKeepingOrderVC alloc] init];
