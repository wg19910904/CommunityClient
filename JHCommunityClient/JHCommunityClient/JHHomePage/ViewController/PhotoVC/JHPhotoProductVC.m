...
@interface JHPhotoProductVC ()<UICollectionViewDelegate, UICollectionViewDataSource>
@property(nonatomic, strong)UICollectionView *collectionView;

@end

@implementation JHPhotoProductVC
{
...
- (void)createMainCollection
{
    if (!_collectionView) {
        ...
        //注册Cell
        [_collectionView registerClass:[JHPhotoCollectionCell class] forCellWithReuseIdentifier:@"JHPhotoCollectionCellID3"];
...
{
    JHPhotoCollectionCell *cell = [_collectionView dequeueReusableCellWithReuseIdentifier:@"JHPhotoCollectionCellID3" forIndexPath:indexPath];
    cell.backgroundColor = [UIColor whiteColor];
    cell.dataDic = dataArray[indexPath.row];
    cell.titleLabel.text = NSLocalizedString(@"商品", nil);
    return cell;
