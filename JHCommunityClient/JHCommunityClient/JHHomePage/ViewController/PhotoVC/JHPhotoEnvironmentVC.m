...
@interface JHPhotoEnvironmentVC ()<UICollectionViewDelegate, UICollectionViewDataSource>
@property(nonatomic, strong)UICollectionView *collectionView;

@end

@implementation JHPhotoEnvironmentVC
{
...
- (void)createMainCollection
{
    if (!_collectionView) {
        ...
        //注册Cell
        [_collectionView registerClass:[JHPhotoCollectionCell class] forCellWithReuseIdentifier:@"JHPhotoCollectionCellID2"];
...
{
    JHPhotoCollectionCell *cell = [_collectionView dequeueReusableCellWithReuseIdentifier:@"JHPhotoCollectionCellID2" forIndexPath:indexPath];
    cell.backgroundColor = [UIColor whiteColor];
    cell.dataDic = dataArray[indexPath.row];
    cell.titleLabel.text = NSLocalizedString(@"环境", nil);
    return cell;
