...
#import "HouseKeepingListAttrModel.h"
//#import "CollectionViewCell.h"
@implementation HouseKeepingListCell
...
//        self.experience = [[UILabel alloc] initWithFrame:FRAME(157, 39, 60, 10)];
//        
//        self.experience.font = FONT(12);
//        self.experience.textColor = HEX(@"999999", 1.0f);
...
//        UICollectionView *collectingView = [weakSelf createCollectionView];
        //[self.contentView addSubview:collectingView];
    }
    return self;
}
- (void)setListModel:(HoseKeepingListModel *)listModel
{
    ...
    CGSize lenghtSize = [self currentSizeWithString:listModel.juli font:FONT(11) withWidth:150];
...
//    self.experience.text = [NSString stringWithFormat:@"%@年经验",];
    ...
    for(NSDictionary *dic in listModel.attr)
    {
        HouseKeepingListAttrModel *model = [[HouseKeepingListAttrModel alloc] init];
