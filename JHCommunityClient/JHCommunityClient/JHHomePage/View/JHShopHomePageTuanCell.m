...
CGFloat JHShopHomePageTuanCell_height;
@implementation JHShopHomePageTuanCell
{
    UIImageView *leftIV;
    UILabel *titleL;
    UILabel *ordersL;
...
- (void)makeUI
{
    leftIV = [[UIImageView alloc] initWithFrame:FRAME(10, 12, 16, 16)];
    leftIV.image = IMAGE(@"tuan");
    [self addSubview:leftIV];
    
    titleL = [[UILabel alloc] initWithFrame:FRAME(30,0,WIDTH - 140, 40)];
    titleL.text = NSLocalizedString(@"团购优惠多多", nil);
    titleL.font = FONT(13);
    titleL.textColor = HEX(@"333333", 1.0f);
    [self addSubview:titleL];
    
    ordersL = [[UILabel alloc] initWithFrame:FRAME(WIDTH - 110, 0, 80, 40)];
    ...
    view1 = [[UIControl alloc] initWithFrame:FRAME(30, 0, WIDTH-30, 70)];
    [view1 addTarget:self action:@selector(tapView1) forControlEvents:(UIControlEventTouchUpInside)];
    [self addSubview:view1];
    view2 = [[UIControl alloc] initWithFrame:FRAME(30, 70, WIDTH-30, 70)];
    ...
    [moreBtn setTitle:NSLocalizedString(@"更多团购 >>", nil) forState:UIControlStateNormal];
...
{
    self.frame = FRAME(0, 0, WIDTH, JHShopHomePageTuanCell_height);
    _dataDic = dataDic;
    if (JHShopHomePageTuanCell_height == 0) {
        ...
        switch (dataArray.count) {
            ...
            case 1:
            {
                shop_id = dataDic[@"childrens"][0][@"shop_id"];
                leftIV.hidden = NO;
                titleL.hidden = YES;
                ordersL.hidden  = YES;
                rightIV.hidden = YES;
                ...
                UIImageView *iv1 = [[UIImageView alloc] initWithFrame:FRAME(0,10, 50, 50)];
                NSURL *url = [NSURL URLWithString:[IMAGEADDRESS stringByAppendingString:array[0][@"photo"]]];
                [iv1 sd_setImageWithURL:url placeholderImage:IMAGE(@"shopDefault")];
                [view1 addSubview:iv1];
                
                UILabel *title1 = [[UILabel alloc] initWithFrame:FRAME(60, 0, WIDTH - 60, 30)];
                title1.text = array[0][@"title"];
                title1.font = FONT(14);
                title1.textColor = HEX(@"333333", 1.0);
                [view1 addSubview:title1];
                
                UILabel *price1L = [[UILabel alloc] initWithFrame:FRAME(60, 35, 90, 30)];
                ...
                UILabel *s_price1L = [[UILabel alloc] initWithFrame:FRAME(150, 35, 150, 30)];
                ...
                UILabel *num1L= [[UILabel alloc] initWithFrame:FRAME(WIDTH - 160, 20, 100, 30)];
                ...
                UIImageView *right1IV = [[UIImageView alloc] initWithFrame:FRAME(WIDTH - 49, 27.5, 9, 15)];
                right1IV.image = IMAGE(@"jiantou_1");
                [view1 addSubview:right1IV];
                
                UIView *line1 = [[UIView alloc] initWithFrame:FRAME(0, 69, WIDTH - 30, 0.5)];
                line1.backgroundColor = LINE_COLOR;
                [view1 addSubview:line1];
                
                moreBtn.frame = FRAME(0, 70, WIDTH, 30);
            ...
            default:
            {
                ...
                UIImageView *iv2 = [[UIImageView alloc] initWithFrame:FRAME(0,10, 50, 50)];
                NSURL *url2 = [NSURL URLWithString:[IMAGEADDRESS stringByAppendingString:array[1][@"photo"]]];
                [iv2 sd_setImageWithURL:url2 placeholderImage:IMAGE(@"shopDefault")];
                [view2 addSubview:iv2];
                
                UILabel *title2 = [[UILabel alloc] initWithFrame:FRAME(60, 0, WIDTH - 60, 30)];
                title2.text = array[1][@"title"];
                title2.font = FONT(14);
                title2.textColor = HEX(@"333333", 1.0);
                [view2 addSubview:title2];
                
                UILabel *price2L = [[UILabel alloc] initWithFrame:FRAME(60, 35, 90, 30)];
                price2L.text = [NSString stringWithFormat:NSLocalizedString(@"¥%g", nil),[array[1][@"price"] floatValue]];
                price2L.font = FONT(15);
                price2L.textColor = HEX(@"ff6600", 1.0);
                [view2 addSubview:price2L];
                
                UILabel *s_price2L = [[UILabel alloc] initWithFrame:FRAME(150, 35, 150, 30)];
                ...
                UILabel *num2L= [[UILabel alloc] initWithFrame:FRAME(WIDTH - 160, 20, 100, 30)];
                ...
                UIImageView *right2IV = [[UIImageView alloc] initWithFrame:FRAME(WIDTH - 49, 27.5, 9, 15)];
                right2IV.image = IMAGE(@"jiantou_1");
                [view2 addSubview:right2IV];
                
                UIView *line2 = [[UIView alloc] initWithFrame:FRAME(0, 69, WIDTH - 30, 0.5)];
                line2.backgroundColor = LINE_COLOR;
                [view2 addSubview:line2];
                
                moreBtn.frame = FRAME(0, 140, WIDTH, 30);
...
{
    if ([haveTuan integerValue] == 0) {
         JHShopHomePageTuanCell_height = 0;
    }else{
        NSArray *array = dic[@"childrens"];
        if (array.count == 0) {
            JHShopHomePageTuanCell_height = 40;
        }else if (array.count == 1){
            JHShopHomePageTuanCell_height = 100;
        }else if (array.count == 2){
            JHShopHomePageTuanCell_height = 170;
        }
    }
    
    return JHShopHomePageTuanCell_height;
}
@end
