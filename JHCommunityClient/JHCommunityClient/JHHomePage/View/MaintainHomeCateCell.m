...
@implementation MaintainHomeCateCell
...
- (void)setProductModel:(MaintainHomeCateProductModel *)productModel
{
    _productModel = productModel;
    NSURL *url = [NSURL URLWithString:[IMAGEADDRESS stringByAppendingString:productModel.icon]];
    [self.pictureImg sd_image:url plimage:IMAGE(@"maintaintwocategory")];
