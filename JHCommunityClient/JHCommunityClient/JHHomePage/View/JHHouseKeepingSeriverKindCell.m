...
@implementation JHHouseKeepingSeriverKindCell
...
- (void)setSeriverModel:(HouseKeepingSeriverKindModel *)seriverModel
{
    _seriverModel = seriverModel;
    NSURL *url = [NSURL URLWithString:[IMAGEADDRESS stringByAppendingString:seriverModel.icon]];
    [self.iconImg sd_image:url plimage:IMAGE(@"housetwocategory")];
