...
@implementation JHTuanGouDetailCellTwo
{
...
- (void)setDataModel:(JHTuanGouDetialCellOneModel *)dataModel
{
    ...
    expiryDateLabel.text = [dataModel.stime stringByAppendingString:
                                      [@"-" stringByAppendingString:dataModel.ltime]];
    expiryDateLabel.font = FONT(12);
    expiryDateLabel.textColor = HEX(@"999999", 1.0);
    
    ruleTitleLabel.frame = FRAME(10, 45, WIDTH - 20, 20);
    ruleTitleLabel.text = NSLocalizedString(@"使用规则:", nil);
    ...
    ruleLabel.text = dataModel.notice;
