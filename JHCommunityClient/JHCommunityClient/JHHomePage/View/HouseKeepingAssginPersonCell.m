...
@implementation HouseKeepingAssginPersonCell
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if(self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
       ...
       //        self.experience = [[UILabel alloc] initWithFrame:FRAME(157 + 30, 32, 60, 10)];
//        self.experience.text = NSLocalizedString(@"7年经验", nil);
...
- (void)setAssignModel:(HoseKeepingListModel *)assignModel
{
