...
@interface JHNewForgetPasswordVC ()<UITextFieldDelegate>
{
    UILabel *topL;
    UILabel *leftL;
    XHCodeTF *phoneF;
...
@implementation JHNewForgetPasswordVC
...
-(void)creatUI{
    ...
    [sureBtn setTitle:@"下一步" forState:0];
...
-(void)getCode{
    ...
    NSDictionary *dic = @{@"mobile":phoneF.text,@"type":@"1"};
...
-(void)pushtoNext{
    ...
    vc.fromVC = @"JHNewForgetPasswordVC";
