...
@implementation JHUpkeepModel
+(JHUpkeepModel * )creatJHUpkeepModelWithDictionary:(NSDictionary *)dic{
    return [[JHUpkeepModel alloc]initWithDictionary:dic];
}
-(id)initWithDictionary:(NSDictionary *)dic{
    if (self == [super init]) {
        ...
        self.chajia = [NSString stringWithFormat:@"%.2f",[_jiesuan_price floatValue] - [_amount floatValue]-self.hongbao.floatValue];
        self.amount = dic[@"amount"];
    }
    return self;
}
