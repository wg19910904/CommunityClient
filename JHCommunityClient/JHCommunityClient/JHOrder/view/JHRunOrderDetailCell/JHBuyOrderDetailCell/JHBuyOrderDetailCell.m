...
@implementation JHBuyOrderDetailCell
{
...
-(void)setModel:(JHRunProgressModel *)model{
    _model = model;
    if(label_state == nil){
...
//        [self.btn setTitle:NSLocalizedString(@"补差价", nil) forState:UIControlStateNormal];
//    }else if ([model.order_status intValue] == 3){
//        [self.btn setTitle:NSLocalizedString(@"服务中", nil) forState:UIControlStateNormal];
//        self.btn.backgroundColor = [UIColor colorWithRed:225/255.0 green:230/255.0 blue:230/255.0 alpha:1];
//    }else{
