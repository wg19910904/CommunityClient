...
#import "JHQueueOrderDetailCellOne.h"
#import "JHQueueDetailCellTwo.h"
#import "JHQueueDetailCellThree.h"
#import "JHQueueOrderCellFour.h"
#import <MJRefresh.h>
...
@interface JHQueueOrderDetailVC ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,MAMapViewDelegate,AVAudioPlayerDelegate>
...
@implementation JHQueueOrderDetailVC
...
-(void)postDetailHttp{
    ...
    [HttpTool postWithAPI:@"client/member/order/detail" withParams:dic success:^(id json) {
        ...
        if ([json[@"error"] isEqualToString:@"0"]) {
            ...
            array = [NSMutableArray arrayWithObjects:@"",@"",NSLocalizedString(@"跑腿类别:代排队", nil),
...
-(void)creatUIScrollView{
    ...
    for (int i = 0; i<2; i++) {
        ...
        if(i == 0){
            ...
            [myTableView_order registerClass:[JHQueueOrderDetailCellOne class] forCellReuseIdentifier:@"cell"];
            [myTableView_order registerClass:[JHQueueDetailCellTwo class] forCellReuseIdentifier:@"cell2"];
            ...
            [myTableView_detail registerClass:[JHQueueDetailCellThree class] forCellReuseIdentifier:@"cell3"];
            [myTableView_detail registerClass:[JHQueueOrderCellFour class] forCellReuseIdentifier:@"cell4"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == myTableView_order) {
        if (indexPath.row == 0) {
            JHQueueOrderDetailCellOne * cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
            ...
            JHQueueDetailCellTwo * cell = [tableView dequeueReusableCellWithIdentifier:@"cell2" forIndexPath:indexPath];
            cell.selectionStyle = UITableViewCellSelectionStyleNone;
...
//            [btn_call addTarget:self action:@selector(clickToCall) forControlEvents:UIControlEventTouchUpInside];
        ...
        if (indexPath.row == 0) {
            JHQueueDetailCellThree * cell = [tableView dequeueReusableCellWithIdentifier:@"cell3" forIndexPath:indexPath];
            cell.selectionStyle = UITableViewCellSelectionStyleNone;
            ...
            JHQueueOrderCellFour * cell = [tableView dequeueReusableCellWithIdentifier:@"cell4" forIndexPath:indexPath];
