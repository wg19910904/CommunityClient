...
#import "JHSeatOrderDetailCellOne.h"
#import "JHSeatOrderDetailCellTwo.h"
#import "JHSeatOrderDetailCellThree.h"
#import "JHSeatOrderDetailCellFour.h"
#import <MJRefresh.h>
...
@interface JHSeatOrderDetailVC ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,MAMapViewDelegate,AVAudioPlayerDelegate>
...
@implementation JHSeatOrderDetailVC
    ...
    [HttpTool postWithAPI:@"client/member/order/detail" withParams:dic success:^(id json) {
        ...
        if ([json[@"error"] isEqualToString:@"0"]) {
         ...
         if(([model_detail.order_status intValue] == 0 && [model_detail.pay_status intValue] == 0)||([model_detail.order_status intValue] == -1&&[model_detail.pay_status intValue] == 0)){
            ...
            array = [NSMutableArray arrayWithObjects:@"",@"",NSLocalizedString(@"跑腿类别:餐馆占座", nil),
...
-(void)creatUIScrollView{
    ...
    for (int i = 0; i<2; i++) {
        ...
        if(i == 0){
            ...
            [myTableView_order registerClass:[JHSeatOrderDetailCellOne class] forCellReuseIdentifier:@"cell"];
            [myTableView_order registerClass:[JHSeatOrderDetailCellTwo class] forCellReuseIdentifier:@"cell2"];
            ...
            [myTableView_detail registerClass:[JHSeatOrderDetailCellThree class] forCellReuseIdentifier:@"cell3"];
            [myTableView_detail registerClass:[JHSeatOrderDetailCellFour class] forCellReuseIdentifier:@"cell4"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == myTableView_order) {
        if (indexPath.row == 0) {
        JHSeatOrderDetailCellOne * cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
        ...
        [cell.btn addTarget:self action:@selector(clickToDoThings:) forControlEvents:UIControlEventTouchUpInside];
            ...
            JHSeatOrderDetailCellTwo * cell = [tableView dequeueReusableCellWithIdentifier:@"cell2" forIndexPath:indexPath];
            cell.selectionStyle = UITableViewCellSelectionStyleNone;
...
//            [btn_call addTarget:self action:@selector(clickToCall) forControlEvents:UIControlEventTouchUpInside];
        ...
        if (indexPath.row == 0) {
            JHSeatOrderDetailCellThree * cell = [tableView dequeueReusableCellWithIdentifier:@"cell3" forIndexPath:indexPath];
            cell.selectionStyle = UITableViewCellSelectionStyleNone;
            ...
            JHSeatOrderDetailCellFour * cell = [tableView dequeueReusableCellWithIdentifier:@"cell4" forIndexPath:indexPath];
            ...
            [cell.textLabel setFont:FONT(13) string:hongbaoStr];
            //添加分割线
            UILabel * _label = [cell viewWithTag:111];
