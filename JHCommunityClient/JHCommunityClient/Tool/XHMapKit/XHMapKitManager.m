...
- (NSString *)currentCity{
    return _currentCity?_currentCity:NSLocalizedString(@"北京", nil);
}
...
- (double)lat{
    if ([XHMapKitManager shareManager].is_International) {
        ...
        CLLocationCoordinate2D gaodePoint = AMapCoordinateConvert(CLLocationCoordinate2DMake(_lat,_lng),AMapCoordinateTypeGPS);
        return gaodePoint.latitude;
    }
