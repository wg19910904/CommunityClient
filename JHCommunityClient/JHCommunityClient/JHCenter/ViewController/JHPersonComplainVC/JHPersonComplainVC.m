//
//  JHPersonComplainVc.m
//  JHCommunityClient
//
//  Created by jianghu2 on 16/4/22.
...
@interface JHPersonComplainVC ()<UITableViewDataSource,UITableViewDelegate,UITextViewDelegate>
{
...
@implementation JHPersonComplainVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        static NSString *identifier = @"complainperson";
        ...
        switch (indexPath.row) {
            case 0:
                cell.title.text = NSLocalizedString(@"服务态度差", nil);
                break;
            case 1:
                cell.title.text = NSLocalizedString(@"电话打不通", nil);
                break;
            case 2:
                cell.title.text = NSLocalizedString(@"未符合订单要求", nil);
                break;
            case 3:
                cell.title.text = NSLocalizedString(@"压根没有来给我服务", nil);
                break;
            case 4:
