...
@interface JHRedPacketRuleVC ()<UIWebViewDelegate>
{
    UIWebView *_webView;
}
@end

@implementation JHRedPacketRuleVC

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = NSLocalizedString(@"红包使用规则", nil);
...
{
    SHOW_HUD
    [HttpTool postWithAPI:@"client/member/hongbao/rule" withParams:@{} success:^(id json) {
        NSLog(@"json%@",json);
